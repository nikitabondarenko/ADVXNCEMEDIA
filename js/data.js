...
const EXPERTISE_DATA = [
    'Deep Technical & AI Understanding',
    'Strategic Product Management Perspective',
    'Proven Modern Marketing & Growth Hacking',
    'Data-Driven Decision Making'
];

// Method Features Data
const METHOD_FEATURES_DATA = [
    {
        icon: '🎯',
        title: 'Product-Led Marketing',
        description: 'We understand your product from the inside out. Our technical background in app development, data science, and AI means we can translate complex offerings into compelling marketing narratives that resonate with your audience and drive product adoption.'
    },
    {
        icon: '🚀',
        title: 'Community-First Growth',
        description: 'We build worlds where your audience wants to live. From Discord communities to social media ecosystems, we create spaces where your brand story comes to life and drives organic growth through authentic connections.'
    },
    {
        icon: '📊',
        title: 'Strategic Storytelling',
        description: 'Every story we craft is designed to capture imagination and drive action. We use strategic insights and performance tracking to ensure your brand narrative builds the world your product needs to thrive.'
    }
];
...
const IMPACT_METRICS_DATA = [
    {
        ...
        value: '5K+',
        description: 'Discord community members built from scratch, driving user retention and advocacy'
    },
    {
        title: 'Engagement Growth',
        value: '100x',
        description: 'Increase in social media engagement through strategic short-form video storytelling'
    },
    {
        title: 'Product Success',
        value: '$4M',
        description: 'Funding secured through community building and product-led growth strategies'
    }
];

// Flowchart Data
const FLOWCHART_DATA = {
    'flow-challenge': '<strong>Start with the client\'s challenge.</strong> We identify the core marketing or growth obstacles faced by startups and small businesses, understanding their unique story and setting the stage for our strategic intervention.',
    'flow-solution': '<strong>Detail our strategic approach.</strong> This is where our storybuilding method, community-first growth strategies, and product-led marketing expertise come into play. We explain how we create the world where your product thrives.',
    'flow-results': '<strong>Showcase measurable impact.</strong> The most crucial part: presenting the undeniable results of our work through compelling stories. Think community growth, engagement increases, funding success, and brand development.'
};

// Style Configuration Data
const STYLE_CONFIG_DATA = {
    palettes: {
        dark: {
            card: 'bg-gray-800 text-white shadow-lg border border-gray-700',
            heading: 'text-white',
            text: 'text-gray-400',
            buttonBg: 'bg-advxnce-accent',
    ...
    fonts: {
        ...
        classic: {
            heading: 'font-inter font-extrabold',
            text: 'font-inter'
        }
    }
}; 